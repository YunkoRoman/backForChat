    ...
    <div className="w-full h-screen bg-bg flex">
      ...
      <div className="flex-1 flex items-center justify-center p-10">
        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-xs flex flex-col gap-7">
          {/* Header */}
          <div>
            <h1 className="text-2xl font-bold text-text mb-2">З поверненням</h1>
            <p className="text-sm text-text-secondary">Увійдіть, щоб продовжити спілкування</p>
          </div>
          ...
          >
            {isSubmitting ? 'Завантажується...' : 'Увійти'}
            {!isSubmitting && (
